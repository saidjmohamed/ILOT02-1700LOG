...
export default function Home(){
 ...
 <div className="card"><div className="sectionTitle"><h3>اختصارات</h3></div><div className="quick"><Link href="/announcements">📢<br/>إعلانات الحي</Link><Link href="/residents/new">➕<br/>إضافة جار</Link><Link href="/treasuries/new">🏦<br/>خزينة جديدة</Link><Link href="/contributions">💰<br/>المساهمات</Link><Link href="/expenses">🧾<br/>المصاريف</Link></div></div></aside></section>
